...
public class JavadocParser extends Parser {
   ...
   public static final int RULE_javadoc = 0, RULE_javadocBody = 1, RULE_singleLineDescription = 2,
      RULE_singleLineTag = 3, RULE_javadocStart = 4, RULE_javadocEnd = 5, RULE_mainDescription = 6, RULE_firstLine = 7,
      RULE_line = 8, RULE_lastLine = 9, RULE_prefix = 10, RULE_text = 11, RULE_tagSection = 12, RULE_tag = 13,
      RULE_tagName = 14;
   public static final String[] ruleNames = { "javadoc", "javadocBody", "singleLineDescription", "singleLineTag",
      "javadocStart", "javadocEnd", "mainDescription", "firstLine", "line", "lastLine", "prefix", "text", "tagSection",
      "tag", "tagName" };
   ...
   public static class JavadocBodyContext extends ParserRuleContext {
      ...
      @Override
      public int getRuleIndex() {
         return RULE_javadocBody;
      }

      @Override
      public void enterRule(ParseTreeListener listener) {
         if (listener instanceof JavadocListener)
            ((JavadocListener) listener).enterJavadocBody(this);
      }

      @Override
      public void exitRule(ParseTreeListener listener) {
         if (listener instanceof JavadocListener)
            ((JavadocListener) listener).exitJavadocBody(this);
      }

      @Override
      public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
         if (visitor instanceof JavadocVisitor)
            return ((JavadocVisitor<? extends T>) visitor).visitJavadocBody(this);
         else
            return visitor.visitChildren(this);
      }
   }
   ...
   public static class SingleLineDescriptionContext extends ParserRuleContext {
      ...
      @Override
      public int getRuleIndex() {
         return RULE_singleLineDescription;
      }

      @Override
      public void enterRule(ParseTreeListener listener) {
         if (listener instanceof JavadocListener)
            ((JavadocListener) listener).enterSingleLineDescription(this);
      }

      @Override
      public void exitRule(ParseTreeListener listener) {
         if (listener instanceof JavadocListener)
            ((JavadocListener) listener).exitSingleLineDescription(this);
      }

      @Override
      public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
         if (visitor instanceof JavadocVisitor)
            return ((JavadocVisitor<? extends T>) visitor).visitSingleLineDescription(this);
         else
            return visitor.visitChildren(this);
      }
   }
   ...
   public static class SingleLineTagContext extends ParserRuleContext {
      ...
      @Override
      public int getRuleIndex() {
         return RULE_singleLineTag;
      }

      @Override
      public void enterRule(ParseTreeListener listener) {
         if (listener instanceof JavadocListener)
            ((JavadocListener) listener).enterSingleLineTag(this);
      }

      @Override
      public void exitRule(ParseTreeListener listener) {
         if (listener instanceof JavadocListener)
            ((JavadocListener) listener).exitSingleLineTag(this);
      }

      @Override
      public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
         if (visitor instanceof JavadocVisitor)
            return ((JavadocVisitor<? extends T>) visitor).visitSingleLineTag(this);
         else
            return visitor.visitChildren(this);
      }
   }
      ...
      try {
         ...
         switch (getInterpreter().adaptivePredict(_input, 12, _ctx)) {
            case 1 :
               enterOuterAlt(_localctx, 1); {
               setState(87);
               if (!(_localctx._lastLine))
                  throw new FailedPredicateException(this, "$_lastLine");
               setState(88);
               firstLine();
               setState(92);
               _errHandler.sync(this);
   ...
   public static class FirstLineContext extends ParserRuleContext {
      ...
      @Override
      public int getRuleIndex() {
         return RULE_firstLine;
      }

      @Override
      public void enterRule(ParseTreeListener listener) {
         if (listener instanceof JavadocListener)
            ((JavadocListener) listener).enterFirstLine(this);
      }

      @Override
      public void exitRule(ParseTreeListener listener) {
         if (listener instanceof JavadocListener)
            ((JavadocListener) listener).exitFirstLine(this);
      }

      @Override
      public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
         if (visitor instanceof JavadocVisitor)
            return ((JavadocVisitor<? extends T>) visitor).visitFirstLine(this);
         else
            return visitor.visitChildren(this);
      }
   }
   ...
   public static class LastLineContext extends ParserRuleContext {
      ...
      @Override
      public int getRuleIndex() {
         return RULE_lastLine;
      }

      @Override
      public void enterRule(ParseTreeListener listener) {
         if (listener instanceof JavadocListener)
            ((JavadocListener) listener).enterLastLine(this);
      }

      @Override
      public void exitRule(ParseTreeListener listener) {
         if (listener instanceof JavadocListener)
            ((JavadocListener) listener).exitLastLine(this);
      }

      @Override
      public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
         if (visitor instanceof JavadocVisitor)
            return ((JavadocVisitor<? extends T>) visitor).visitLastLine(this);
         else
            return visitor.visitChildren(this);
      }
   }
      ...
      try {
         ...
         switch (getInterpreter().adaptivePredict(_input, 29, _ctx)) {
            case 1 :
               enterOuterAlt(_localctx, 1); {
               setState(151);
               if (!(_localctx.prefixed))
                  throw new FailedPredicateException(this, "$prefixed");
               setState(159);
               _errHandler.sync(this);
               _alt = 1;
               do {
      ...
      try {
         ...
         switch (getInterpreter().adaptivePredict(_input, 42, _ctx)) {
            case 1 :
               enterOuterAlt(_localctx, 1); {
               setState(196);
               if (!(_localctx._firstLine))
                  throw new FailedPredicateException(this, "$_firstLine");
               setState(197);
               match(AT);
               setState(199);
   ...
   public static final String _serializedATN = "\3\u0430\ud6d1\u8206\uad2d\u4417\uaef1\u8d80\uaadd\3\t\u00ff\4\2\t\2\4"
