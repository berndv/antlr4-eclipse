...
public class LineParser extends Parser {
   ...
   public static class JavadocContext extends ParserRuleContext {
      ...
      public void enterRule(ParseTreeListener listener) {
         if (listener instanceof LineListener)
            ((LineListener) listener).enterJavadoc(this);
      }

      @Override
      public void exitRule(ParseTreeListener listener) {
         if (listener instanceof LineListener)
            ((LineListener) listener).exitJavadoc(this);
      }

      @Override
      public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
         if (visitor instanceof LineVisitor)
            return ((LineVisitor<? extends T>) visitor).visitJavadoc(this);
         else
   ...
   public static class JavadocStartContext extends ParserRuleContext {
      public List<TerminalNode> STAR() {
         return getTokens(LineParser.STAR);
      }
      ...
      public List<TerminalNode> WS() {
         return getTokens(LineParser.WS);
      }
      ...
      public void enterRule(ParseTreeListener listener) {
         if (listener instanceof LineListener)
            ((LineListener) listener).enterJavadocStart(this);
      }

      @Override
      public void exitRule(ParseTreeListener listener) {
         if (listener instanceof LineListener)
            ((LineListener) listener).exitJavadocStart(this);
      }

      @Override
      public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
         if (visitor instanceof LineVisitor)
            return ((LineVisitor<? extends T>) visitor).visitJavadocStart(this);
         else
            return visitor.visitChildren(this);
      }
   }
   ...
   public static class JavadocEndContext extends ParserRuleContext {
      ...
      public void enterRule(ParseTreeListener listener) {
         if (listener instanceof LineListener)
            ((LineListener) listener).enterJavadocEnd(this);
      }

      @Override
      public void exitRule(ParseTreeListener listener) {
         if (listener instanceof LineListener)
            ((LineListener) listener).exitJavadocEnd(this);
      }

      @Override
      public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
         if (visitor instanceof LineVisitor)
            return ((LineVisitor<? extends T>) visitor).visitJavadocEnd(this);
         else
            return visitor.visitChildren(this);
      }
   }
   ...
   public static class MainDescriptionContext extends ParserRuleContext {
      ...
      public void enterRule(ParseTreeListener listener) {
         if (listener instanceof LineListener)
            ((LineListener) listener).enterMainDescription(this);
      }

      @Override
      public void exitRule(ParseTreeListener listener) {
         if (listener instanceof LineListener)
            ((LineListener) listener).exitMainDescription(this);
      }

      @Override
      public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
         if (visitor instanceof LineVisitor)
            return ((LineVisitor<? extends T>) visitor).visitMainDescription(this);
         else
            return visitor.visitChildren(this);
      }
   }
   ...
   public static class LineContext extends ParserRuleContext {
      ...
      public TerminalNode NL() {
         return getToken(LineParser.NL, 0);
      }
      ...
      public void enterRule(ParseTreeListener listener) {
         if (listener instanceof LineListener)
            ((LineListener) listener).enterLine(this);
      }

      @Override
      public void exitRule(ParseTreeListener listener) {
         if (listener instanceof LineListener)
            ((LineListener) listener).exitLine(this);
      }

      @Override
      public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
         if (visitor instanceof LineVisitor)
            return ((LineVisitor<? extends T>) visitor).visitLine(this);
         else
            return visitor.visitChildren(this);
      }
   }
      ...
      try {
         ...
         switch (getInterpreter().adaptivePredict(_input, 8, _ctx)) {
            ...
            case 4 :
               ...
               setState(65);
               if (!(_localctx.allowMissingNl))
                  throw new FailedPredicateException(this, "$allowMissingNl");
               setState(66);
               text(false);
            }
               break;
   ...
   public static class PrefixContext extends ParserRuleContext {
      ...
      public void enterRule(ParseTreeListener listener) {
         if (listener instanceof LineListener)
            ((LineListener) listener).enterPrefix(this);
      }

      @Override
      public void exitRule(ParseTreeListener listener) {
         if (listener instanceof LineListener)
            ((LineListener) listener).exitPrefix(this);
      }

      @Override
      public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
         if (visitor instanceof LineVisitor)
            return ((LineVisitor<? extends T>) visitor).visitPrefix(this);
         else
            return visitor.visitChildren(this);
      }
   }
   ...
   public static class TextContext extends ParserRuleContext {
      ...
      public List<TerminalNode> WORD() {
         return getTokens(LineParser.WORD);
      }
      ...
      public List<TerminalNode> AT() {
         return getTokens(LineParser.AT);
      }
      ...
      public void enterRule(ParseTreeListener listener) {
         if (listener instanceof LineListener)
            ((LineListener) listener).enterText(this);
      }

      @Override
      public void exitRule(ParseTreeListener listener) {
         if (listener instanceof LineListener)
            ((LineListener) listener).exitText(this);
      }

      @Override
      public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
         if (visitor instanceof LineVisitor)
            return ((LineVisitor<? extends T>) visitor).visitText(this);
         else
            return visitor.visitChildren(this);
      }
   }
   ...
   public static final String _serializedATN = "\3\u0430\ud6d1\u8206\uad2d\u4417\uaef1\u8d80\uaadd\3\t\177\4\2\t\2\4\3"
      ...
      + "\2\2\2|X\3\2\2\2|d\3\2\2\2|v\3\2\2\2}\17\3\2\2\2\25\22\32 &.\65\67;EJ" + "PU]bhotz|";
